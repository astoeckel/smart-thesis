...
\usepackage[pdfencoding=auto,pdfborderstyle={/S/U/W 1},linkbordercolor=ref,colorlinks=true,linkcolor=ref,citecolor=cite,urlcolor=url]{hyperref} % Clickable references.
