...
\usepackage[disable,color=YellowGreen,textsize=tiny,shadow]{todonotes} % Todo notes.
...
\usepackage[pdfencoding=auto,pdfborderstyle={/S/U/W 1},linkbordercolor=DarkSlateBlue,colorlinks=true,linkcolor=DarkSlateBlue,citecolor=DarkOliveGreen,urlcolor=Maroon]{hyperref} % Clickable references.
