...
% These packages are only used in the demo and not really
...
\begin{align}
  ...
  z &= \sqrt{x^2 + y^2}
\end{align}
\marginnote{Did you know? The discrete fourier transfortmation shown in equation \ref{eqn:dft} is the backbone of the modern information-society.}
...
\begin{figure}
	\centering % @Jan: What package did you use for auto-centering of figures?
	\begin{tikzpicture}
		\begin{axis}[
			axis lines=left,
			scaled ticks=false,
